...
public class Pagina implements Iterable<Tupla> {
    ...
    public void adicionarTupla(Tupla tupla)
        ...
        if (hayEspacio(tupla)) {
            ...
            espacioLibre -= GestorIOTupla.byteSize(getRelacion(), tupla);
             ...
             /* aqui creamos una nueva pagina, si la siguiente pagina es nula la creamos en caso
              * contrario nos vamos a la sgte pagina e insertamos en la siguiente pagina
              */
             if(this.getSgtePagina() == null){
                IdentificadorPagina pid = new IdentificadorPagina(this.idPagina.getNombreArchivo(), this.idPagina.getNumero() + 1);
                this.SgtePagina = new Pagina(this.relacion, pid);
             }
             SgtePagina.adicionarTupla(tupla);
    ...
    public String toString() {
        ...
        sb.append("}");
        if(SgtePagina != null) sb.append("\n").append(this.SgtePagina.toString());
        return sb.toString();
    }
}